  ...
  do {
    if (0 === exitStatus) {
      ...
      if (
        ...
        forceSync = now$1();
        renderWasConcurrent = renderStartTime;
        supportsUserTiming &&
          ((reusableLaneDevToolDetails.color = "error"),
          (reusableLaneOptions.start = renderWasConcurrent),
          (reusableLaneOptions.end = forceSync),
        ...
        switch (exitStatus) {
          ...
          case 6:
            ...
            supportsUserTiming &&
              ...
              (reusableLaneOptions.end = exitStatus),
              performance.measure("Prewarm", reusableLaneOptions));
            finalizeRender(lanes, renderWasConcurrent);
            markRootSuspended(
              shouldTimeSlice,
              lanes,
              workInProgressDeferredLane,
...
if (
  "19.0.0-experimental-4beb1fd8-20241118" !==
